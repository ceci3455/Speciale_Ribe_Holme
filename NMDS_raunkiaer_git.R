...
Dir.Data <- file.path(Dir.Base, 'p_raunkiaer_all.csv') # index the data folder
...
# Softcoding working directory
Dir.Base <- getwd() # to find the project folder
Dir.Data <- file.path(Dir.Base, 'total_artsliste.csv') # index the data folder
...
# Softcoding working directory
Dir.Base <- getwd() # to find the project folder
Dir.Data <- file.path(Dir.Base, 'scale_miljo.csv') # index the data folder
...
# Softcoding working directory
Dir.Base <- getwd() # to find the project folder
Dir.Data <- file.path(Dir.Base, 'NMDS_afgrode.csv') # index the data folder
